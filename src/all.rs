...
pub enum ORanges {
    Ocmpw = O::Oceqw as isize,
    Ocmpw1 = O::Ocultw as isize,
    Ocmpl = O::Oceql as isize,
    Ocmpl1 = O::Ocultl as isize,
    Ocmps = O::Oceqs as isize,
    Ocmps1 = O::Ocuos as isize,
    Ocmpd = O::Oceqd as isize,
    Ocmpd1 = O::Ocuod as isize,
    Oalloc = O::Oalloc4 as isize,
    Oalloc1 = O::Oalloc16 as isize,
    Oflag = O::Oflagieq as isize,
    Oflag1 = O::Oflagfuo as isize,
    NPubOp = O::Onop as isize,
    Jjf = J::Jjfieq as isize,
    Jjf1 = J::Jjffuo as isize,
}
